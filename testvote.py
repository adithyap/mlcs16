...
newframe.to_csv('/scratch/sv1239/projects/mlcs/mlcs16/testout.csv')
(pd.DataFrame(output)).to_csv('/scratch/sv1239/projects/mlcs/mlcs16/testoutput.csv')
print time.time()-start
# In[ ]:
